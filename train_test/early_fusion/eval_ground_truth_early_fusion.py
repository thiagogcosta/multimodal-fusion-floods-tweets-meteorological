...
def processing_df_early_fusion_100(model, ground_truth):
...
my_database = con_mongo.create_db('enoesocial-tweets_early_fusion-EVAL-OK-JOURNAL')
...
result.to_csv(local_model_result+'socialflood_model_conj_vdd_BOW_tweets_early_fusion.csv')
        
#----------------------------PREPARANDO O DATASET----------------------------

model = pd.read_csv(local_model_result+'socialflood_model_conj_vdd_BOW_tweets_early_fusion.csv')
...
ground_truth_ok = processing_df_early_fusion_100(model, ground_truth)

print(ground_truth_ok)

ground_truth_ok.to_csv(local_model_result + 'socialflood_model_conj_vdd_BOW_tweets_early_fusion_CERTO.csv')

#***********Processing***********

ground_truth_ok = pd.read_csv(local_model_result + 'socialflood_model_conj_vdd_BOW_tweets_early_fusion_CERTO.csv')
...
loaded_model = joblib.load(local_model_result + 'dt_train_model_early_fusion.sav')
...
df_result.to_csv(local_model_result + 'resultado_predict_early_fusion.csv')

df_target = pd.DataFrame(data=result.flatten())

df_target.to_csv(local_model_result + 'resultado_target_early_fusion.csv')
