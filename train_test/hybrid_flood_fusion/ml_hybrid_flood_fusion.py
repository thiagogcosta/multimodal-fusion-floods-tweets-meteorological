...
class ML:
    ...
    def __init__(self, percentage_test):
    ...
    def RF_classifier(self, data):
        ...
        random_forest = RandomForestClassifier(n_estimators = 100, min_samples_split = 8, min_samples_leaf = 3, max_features = 3, max_depth = 90, bootstrap=True)
        
        #------Results of cross validation------
        random_forest_values = self.cross_apply(random_forest, X, y.values.ravel())

        return random_forest_values
    ...
    def SVM_classifier(self, data):
        ...
        classifier = SVC(C=0.01, gamma=0.001, kernel= 'linear', decision_function_shape = 'ovo', shrinking= True)
    ...
    def NB_classifier(self, data):
        ...
        gaussian_nb = GaussianNB(var_smoothing = 0.000000432876)

        #------Results of cross validation-----
        
        gaussian_nb_results = self.cross_apply(gaussian_nb, X, y.values.ravel())

        return gaussian_nb_results
    ...
    def RL_classifier(self, data):
        ...
        logistic_regression_classifier = LogisticRegression(C=0.09, penalty = 'l1', multi_class='ovr', solver='liblinear')

        #------Results of cross validation-----
        logistic_regression_values = self.cross_apply(logistic_regression_classifier, X, y.values.ravel())

        return logistic_regression_values
