...
def preprocess_tweets_bow_tfidf(tweets_early_fusion, dict_hashtag, con_mongo, my_database):
    ...
    dataframe_most_freq.to_csv(local_model_result + 'most_freq_words_tweets_early_fusion.csv')
    #--------------------------------------------------------------------------------------------
...
# unimodal_folder folder location
...
my_database = con_mongo.create_db('enoesocial-tweets_unimodal_fusion-OK-JOURNAL')
...
tweets_unimodal_fusion = pd.read_csv(local_model + 'THIAGO_NOV2016_NOV2018_judge_CERTO_INSIDE_sp_cluster_FEATURES_modelo_early_fusion.csv' , sep=(','))

tweets_unimodal_fusion = tweets_unimodal_fusion[['index', 'id_str', 'created_at', 
                                                'longitude', 'latitude',
...
preprocess_tweets_fasttext_word2vec(tweets_unimodal_fusion, dict_hashtag, kw, con_mongo, my_database, type_name)
...
#------------------PRE-PROCESSING - BOW / TF-IDF---------------------
preprocess_tweets_bow_tfidf(tweets_unimodal_fusion, dict_hashtag, con_mongo, my_database)
