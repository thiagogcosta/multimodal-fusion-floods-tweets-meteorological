...
2. **textual-features** folder:
    ...
    - Create the directory called "**FastText**" inside the "**embeddings**" folder;
        - Insert the NILC FastText templates of the SKIP-GRAM type with 50 and 100 dimensions and CBOW with 50 and 100 dimensions.
    ...
    - Create the directory called "**Word2Vec**" inside the "**embeddings**" folder;
        - Insert the NILC Word2Vec templates of the SKIP-GRAM type with 50 and 100 dimensions and CBOW with 50 and 100 dimensions.
        - For more information: http://www.nilc.icmc.usp.br/embeddings.
